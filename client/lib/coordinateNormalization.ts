 ...
 */
export function normalizeToOriginBoxSpace(element: DrawingElement): {
  x: number;
  y: number;
  ...
  console.log(
    `Normalized element ${element.id}: (${element.x}, ${element.y}) -> (${clampedX}, ${clampedY})`,
  );
 ...
 */
export function normalizeElementsToOriginBoxSpace(
